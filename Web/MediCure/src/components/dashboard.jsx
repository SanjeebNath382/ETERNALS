...
function Dashboard() {
  ...
  <span className="w3-bar-item w3-right">MediCure</span>
</div>
...
<header class="w3-container" style={{paddingTop:"22px"}}>
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style={{marginBottom:"0px", marginLeft: "-16px"}}>
      {/* <div class="w3-third">
        <h5>Regions</h5>
  ...
  <div class="w3-container">
    ...
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
      ...
      <tr>
        <td>Physical heath Report</td>
        <td>Good</td>
      </tr>
      <tr>
        <td>Mental health</td>
        <td>Require Counselling</td>
      </tr>
      {/* <tr>
        <td>India</td>
        <td>1.9%</td>
    ...
    <button class="w3-button w3-dark-grey">More Records  <i class="fa fa-arrow-right"></i></button>
  </div>
  <hr />
